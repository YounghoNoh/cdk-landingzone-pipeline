...
export class StacksetCloudtrail extends Construct {
  constructor(scope: Construct, id: string ) {
    ...
    new cdk.CfnStackSet(this, 'cloudtrail', {
      ...
      // templateUrl: 'https://cdklz-stackset-template.s3.ap-northeast-2.amazonaws.com/cloudtrail.template.yaml',
      templateUrl: `https://cdklz-stackset-template-${envVars.MASTER.ACCOUNT_ID}.s3.ap-northeast-2.amazonaws.com/cloudtrail.template.yaml`,
    });
